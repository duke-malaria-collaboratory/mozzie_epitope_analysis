...
DV10_randomcoxme <- readRDS("figures/robj/DV10_random_coxme_fig.RDS")

DV10_randomsurv <- readRDS("figures/robj/DV10_random_strat_survival.RDS")
...
sunburst_plot_horizontal <- ggarrange(dv10_sunburst +
                             scale_color_manual(guide = "none", values = c("grey5", "white")) +
                               #labs(title = "CSP DV10") +
                             scale_alpha_manual(values = c("0" = 0, "1" = 1, "2" = 0.5), guide = "none") +
                                          theme(plot.title = element_text(hjust = 0.5, face = "bold"), plot.margin = unit(c(0,0,0,0), "cm")),
...
moi_plot_horizontal <- ggarrange(NULL,
                      dv10_moi_alt +
              labs(title = NULL)+
                theme(plot.margin = unit(c(0,0,0,0), "cm")),
              NULL,
            ...
            NULL,
            nrow = 1,
            widths = c(0.05,1,0.2,1,0.2,1,0.2,1,0.1),
            align = "v",
            common.legend = TRUE,
            legend = "bottom")

moi_sunburst_horizontal <- ggarrange(sunburst_plot_horizontal,
                                     NULL,
                          moi_plot_horizontal,
                          nrow = 3,
                          heights = c(6,-1.5,3),
...
ggsave(plot = moi_sunburst_horizontal, "figures/moi_sunburst_horizontal.png", width = 15, height = 10)
...
Combined_random_strat <- ggarrange(Combined_randomsurv +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            labs(title = "Time to random reinfection") +
            theme_bw() +
...
Combined_homol_strat <- ggarrange(ggarrange(Combined_homolsurv$plot +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            labs(title = "Time to homologous reinfection") +
            theme_bw() +
            theme(plot.title = element_text(hjust = 0.5), legend.position = "none"),
            NULL,
...
#remove rectangle from Combined_homolvrandom
Combined_homolvrandom$layers[[4]] <- NULL
Combined_homolrandom_Asx$layers[[4]] <- NULL
Combined_homolrandom_Sx$layers[[4]] <- NULL

combined_allhomolrandom <- ggarrange(Combined_homolvrandom +
            labs(title = " \nAll episodes", x = " ") +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            theme(plot.title = element_text(hjust = 0.5)),
          Combined_homolrandom_Asx +
            labs(title = " \nAsymptomatic episodes", y = " ") +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            theme(plot.title = element_text(hjust = 0.5)),
          Combined_homolrandom_Sx +
            labs(title = " \nSymptomatic episodes", x = " ", y = " ") +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            theme(plot.title = element_text(hjust = 0.5)),
          nrow = 1,
...
combined_top <- ggarrange(ggarrange(combined_moi_alt +
            labs(title = "")+
...
combined_combined <- ggarrange(combined_top,
                               NULL,
                               combined_allhomolrandom,
                               nrow = 3,
                               heights = c(1.5,0.1,1.1))

ggsave(plot = combined_combined, "figures/combined_fig.png", width = 13, height = 10)
...
DV10_randomcoxme$data$variable <- factor(DV10_randomcoxme$data$variable, levels = c("Symptomatic", "Mosquitoes > 50", "Type prevalence", "Male", 
"Age 5-15", "Age > 15"))

DV10_random_strat <- ggarrange(DV10_randomsurv +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            labs(title = "Time to random reinfection") +
            theme_bw() +
...
DV10_homolcoxme$data$label <- factor(DV10_homolcoxme$data$label, levels = c("Age >15", "Age 5 - 15", "Male", "Type prevalence", "Mosquitoes > 50", 
"Symptomatic"))

DV10_homol_strat <- ggarrange(ggarrange(DV10_homolsurv$plot +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            labs(title = "Time to homologous reinfection") +
            theme_bw() +
...
#remove rectangle from DV10_homolvrandom
DV10_homolvrandom$layers[[4]] <- NULL
DV10_homolrandom_Asx$layers[[4]] <- NULL
DV10_homolrandom_Sx$layers[[4]] <- NULL

DV10_allhomolrandom <- ggarrange(DV10_homolvrandom +
            labs(title = " \nAll episodes", x = " ") +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            theme(plot.title = element_text(hjust = 0.5)),
          DV10_homolrandom_Asx +
            labs(title = " \nAsymptomatic episodes", y = " ") +
            geom_vline(xintercept = 60, linetype = "dotted") +
            scale_x_continuous(breaks = c(0,60,100,200,300,400)) +
            theme(plot.title = element_text(hjust = 0.5)),
...
DV10_bottom <- ggarrange(DV10_random_strat,
                      NULL,
          DV10_homol_strat,
          ncol = 3,
          nrow = 1,
...
DV10_combined <- ggarrange(DV10_allhomolrandom,
                               NULL,
                               DV10_bottom,
                               nrow = 3,
                               heights = c(1.1,0.1,1))

ggsave(plot = DV10_combined, "figures/DV10_fig.png", width = 15, height = 10)
